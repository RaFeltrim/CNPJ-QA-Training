...
|-------|-----|-----------|---------------------|
| **Nível 1** | Verde | **Exemplo Completo** | Resposta detalhada com todos os passos explicados |
| **Nível 2** | Amarelo | **Estrutura Guiada** | Campos para preencher com dicas e orientação |
| **Nível 3** | Laranja | **Modelo Simplificado** | Formato básico para você relembrar o processo |
| **Nível 4** | Vermelho | **Resolução Independente** | Apenas o enunciado - resolva sozinho |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Verde    - 100% Apoio  →  Aprende observando o método completo
Amarelo  -  70% Apoio  →  Pratica com estrutura e dicas
Laranja  -  40% Apoio  →  Relembra com formato básico
Vermelho -   0% Apoio  →  Aplica conhecimento de forma autônoma
```
...
|-----------|------|--------|
| **Ex. 1-4** | Cálculo de Dígitos Verificadores (Numéricos) | Verde/Amarelo/Laranja/Vermelho |
| **Ex. 5** | Reconhecer Componentes do CNPJ | Verde/Amarelo/Laranja/Vermelho |
| **Ex. 9-11** | Prática Adicional de Cálculos | Verde/Amarelo/Vermelho |
| **Ex. 13** | Conversão ASCII | Verde/Amarelo/Laranja/Vermelho |
| **Ex. 14** | Completar Sequência | Verde/Vermelho |
| **Ex. 16-18** | Cálculos Alfanuméricos | Verde/Amarelo/Vermelho |
| **Ex. 20** | Validação de Caracteres | Verde/Amarelo/Laranja/Vermelho |
...
|-----------|------|----------------|----------|
| **1** | 12.345.678/0001-XX | Verde - **Completo** | Aprenda o método passo a passo |
| **2** | 98.765.432/0002-XX | Amarelo - **Estrutura guiada** | Pratique com campos para preencher |
| **3** | 11.111.111/0001-XX | Laranja - **Modelo simplificado** | Relembre o formato de cálculo |
| **4** | 99.999.999/9999-XX | Vermelho - **Independente** | Resolva sozinho, sem assistência |
...
**Nível**: Verde - Resposta completa - Use como referência
